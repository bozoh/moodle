...
$version = '3.4';
$test_type = 'none'; //'none', 'behat', 'phpunit'

$CFG->dbtype    = 'pgsql';      // 'pgsql', 'mariadb', 'mysqli', 'mssql', 'sqlsrv' or 'oci'
$CFG->dblibrary = 'native';     // 'native' only at the moment
$CFG->dbhost    = 'localhost';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'moodles';     // database name, eg moodle
$CFG->dbuser    = 'moodle-dev-'.$version;   // your database username
$CFG->dbpass    = $CFG->dbuser;   // your database password
...
$CFG->wwwroot   = 'http://localhost/moodle-git';
...
$CFG->dataroot  = '/opt/moodle/moodle-dev';
...
$CFG->divertallemailsto = ''; // NOT FOR PRODUCTION SERVERS!
...
$CFG->moodlecourse_enablecompletion = true;
//tests
//PHPUNIT
//Init command:
...
if ($test_type=='phpunit') {
    ...
    $CFG->phpunit_dataroot = $CFG->dataroot.'-test_phpunit';
}
//BEHAT
//For selenium test please visit:
...
//php -S 10.1.100.62:8000 &>/dev/null &
...
//######## CODE CHECKER
// ## to check
// phpcs --standard="local/codechecker/moodle" --encoding="UTF-8" --ignore="lib/*, tests/*, pix/*" -a mod/simplecertificate
// ## to do auto fix
// phpcbf --standard="local/codechecker/moodle" --encoding="UTF-8" --ignore="lib/*, tests/*, pix/*" -a mod/simplecertificate
//
if ($test_type=='behat'){
    $CFG->behat_dataroot = $CFG->dataroot.'-test_behat';
    $CFG->behat_prefix = 'behat_';
    $CFG->behat_wwwroot='http://10.1.100.62:8000';
    #$CFG->behat_wwwroot='http://DECEX-ATI-DES11:8000';
    $CFG->behat_debug = (E_ALL | E_STRICT);   // === DEBUG_DEVELOPER - NOT FOR PRODUCTION SERVERS!
    $CFG->behat_debugdisplay = 1;             // NOT FOR PRODUCTION SERVERS!
    $CFG->behat_yuiloglevel = 'debug';
    $CFG->behat_langstringcache = false; // NOT FOR PRODUCTION SERVERS!
    $CFG->behat_noemailever = true;
    // Divert all outgoing emails to this address to test and debug emailing features
    // $CFG->behat_divertallemailsto = 'root@localhost.local'; // NOT FOR PRODUCTION SERVERS!
